  ...
  return (
    <section ref={ref} className="relative z-10 w-full py-24" style={{ background: "#111111" }}>
      <div className="max-w-[900px] mx-auto px-6">
        ...
        >
          {/* Top Row: Quote Icon & News Badge */}
          <div className="flex items-center justify-between mb-8">
            <svg className="opacity-20" width="36" height="28" viewBox="0 0 36 28" fill="none">
              <path
            ...
            <a
              href="/impact"
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold transition-all hover:opacity-90"
              style={{
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pt-6 border-t border-white/5">
            ...
            {/* Link to News Coverage / Impact Page */}
            <a
              href="/impact"
              className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider transition-colors hover:underline"
              style={{ color: "#f97316" }}
            >
